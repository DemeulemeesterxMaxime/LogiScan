...
class SampleData {
    static func createSampleData(modelContext: ModelContext) {
        ...
        let event1 = Event(
            ...
            clientName: "ISEN École d'Ingénieurs",
            clientPhone: "04 94 03 89 50",
            clientEmail: "contact@isen.fr",
            clientAddress: "Campus ISEN, 20 Avenue de la Victoire, 83000 Toulon",
            eventAddress: "Campus ISEN, 20 Avenue de la Victoire, 83000 Toulon",
        ...
        let event2 = Event(
            ...
            clientName: "Mairie de Toulon",
            clientPhone: "04 94 36 30 00",
            clientEmail: "culture@mairie-toulon.fr",
            clientAddress: "Place de la Liberté, 83000 Toulon",
            eventAddress: "Place de la Liberté, 83000 Toulon",
